...
- FrontEnd service is responsible for:
  ...
  - Usage data collection : When we gather real-time information that can be used for audit. And even though FrontEnd service has many responsibilities, the rule of thumb is to keep it as simple as possible. 
